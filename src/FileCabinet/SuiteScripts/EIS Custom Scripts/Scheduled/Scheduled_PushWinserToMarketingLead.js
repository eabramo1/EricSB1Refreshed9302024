/*
* Script:     Scheduled_PushWinserToMarketingLead.js
* 
...
* 
* Amendment Log:
* 	February 2018			E Abramo			Deployed to Production
* 	Decenber 2019			E Abramo			US582198 Script Errors - Scheduled Winser Item to Marketing Lead
* 												Need to accommodate for API Governance limits
* 
* 
*/
...
function write_winser_to_mlo( )
{
	...
	var winser_filters = new Array();
		...
		winser_filters[3] = new nlobjSearchFilter('custcol_winser_last_updated', null, 'after', last_runtime_dateTime); // after Last_Runtime_Date_Time
